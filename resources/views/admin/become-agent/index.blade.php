                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="modelHeading">Thêm ưu đãi</h4>
                        </div>
                        <div class="modal-body">
                            <form class="form-horizontal" action="{{route('cms.become-agent.store')}}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="title" name="title"
                                               placeholder="Nhập title " value="" maxlength="50">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="content" name="content"
                                               placeholder="Nhập content " value="" maxlength="50">
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('#configTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('cms.become-agent.index') }}",
                language: {
                    search: 'Nhập tên',
            ...
            $('body').on('click', '.editProperty', function () {
                ...
                $.get("{{ route('cms.become-agent.index') }}" + '/' + property_id + '/edit', function (data) {
                    $('#modelHeading').html("Cập nhật thông tin ưu đãi");
            ...
            $('body').on('click', '.deleteProperty', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ url('cms/become-agent/destroy') }}" + '/' + config_id,
